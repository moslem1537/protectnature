...
<body>
  ...
  <main class="site-main">
    ...
    <div class="content mt-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <legend>gestion de livraison</legend >
            ...
            <?PHP
                foreach($listelivraison as $liv){
            ?>
                <tr>
                    <td><?PHP echo $liv['id']; ?></td>
                    <td><?PHP echo $liv['nom']; ?></td>
                    <td><?PHP echo $liv['produit']; ?></td>
                    <td><?PHP echo $liv['quantite']; ?></td>
                    ...
                    <td>
                        <a href="modifierlivraison.php?id=<?PHP echo $liv['id']; ?>"> Modifier </a>
                    </td>
                </tr>
            <?PHP
                }
