...
<head>
  ...
  <meta charset="UTF-8">
  <title>Afficher Liste produits</title>
    <style >
    #ajouter {
      position: fixed;
      left: 20%;
  ...
  <div class="d-sm-flex justify-content-center justify-content-sm-between">
   ...
   <?php 
     ...
     if(isset($_GET['search'])){
        ...
        $sql = "SELECT * FROM produits WHERE nom LIKE '%$searchKey%'";
     }else
   ...
   <form action="" method="GET"> 
     ...
     <div class="col-md-6">
        <input id="sea" type="text" name="search"  placeholder="Search By Name" value=<?php echo @$_GET['search']; ?> > 
     </div>
