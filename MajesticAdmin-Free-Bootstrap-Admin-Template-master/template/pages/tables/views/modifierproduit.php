...
<html lang="en">
    ...
    <body>
        <button id="retourm"><a href="afficherproduit.php">Retour à la liste</a></button>
        ...
        <form action="" method="POST" >
            <table id="tabm">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="nom" id="nom" maxlength="20" value = "<?php echo $prod['nom']; ?>">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="number" name="prix" id="prix"  value = "<?php echo $prod['prix']; ?>"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" name="quantite" id="quantite"  value = "<?php echo $prod['quantite']; ?>">
                    </td>
                </tr>
                <tr>
