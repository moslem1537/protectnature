...
<html>
  ...
  <title>Protect Nature- Checkout</title>
        ...
        <form name="form" action="" method="POST"> 
            <table align="center">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="produit" id="produit" maxlength="20" value = "<?php echo $prod['produit']; ?>">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <label for="quantites">quantites:
                        </label>
                    </td>
                    <td>
                        <input type="number" name="quantites" id="quantites"  value = "<?php echo $prod['quantites']; ?>">
                    </td>
                </tr>
                <tr>
